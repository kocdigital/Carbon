...
namespace Carbon.HttpClients
{
    ...
    public static class IServiceCollectionExtensions
    {
        ...
        public static void AddHttpClientWithHeaderPropagation(this IServiceCollection services,SqlTruncateException, Action<HeaderPropagationOptions> configureHeaderPropagation)
        {
