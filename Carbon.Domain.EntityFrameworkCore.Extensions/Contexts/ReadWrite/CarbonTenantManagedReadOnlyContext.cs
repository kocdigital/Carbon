...
namespace Carbon.Domain.EntityFrameworkCore
{
    ...
    public class CarbonTenantManagedReadOnlyContext<TContext> : CarbonReadOnlyContext<TContext>, IReadOnlyContext where TContext : DbContext
    {
        /// <summary>
        ...
        public CarbonTenantManagedReadOnlyContext(DbContextOptions options) : base(options)
        {
