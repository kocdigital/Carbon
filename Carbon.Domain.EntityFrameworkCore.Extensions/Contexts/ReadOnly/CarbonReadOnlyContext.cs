...
namespace Carbon.Domain.EntityFrameworkCore
{
    ...
    public class CarbonReadOnlyContext<TContext> : CarbonContext<TContext>, IReadOnlyContext where TContext : DbContext
    {
        /// <summary>
        ...
        public CarbonReadOnlyContext(DbContextOptions options) : base(options)
        {
